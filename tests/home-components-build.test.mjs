...
`,
    ...
    for (const href of ['/search', '/explore', '/favorites', '/calendar', '/timeline', '/rss.xml', '/weather', '/random-image', '/github', '/ai', '/stats', '/status', '/subscribe', '/music']) {
    ...
    assert.equal((html.match(/data-portal-tool=/g) ?? []).length, 14, 'expected all ready and preview tools to remain discoverable');
