...
`,
    ...
    for (const href of ['/search', '/explore', '/today', '/favorites', '/calendar', '/timeline', '/rss.xml', '/weather', '/random-image', '/github', '/ai', '/stats', '/status', '/subscribe', '/music']) {
    ...
    assert.equal((html.match(/data-portal-tool=/g) ?? []).length, 15, 'expected all ready and preview tools to remain discoverable');
